...
get usamapPath() { return this.add("usamap path"); }
get drinkLink() { return this.add("drink-link"); }
get drinkForm() { return this.add("drink-form"); }
get drinkFocus() { return this.add("drink-focus"); }
get drinkName() { return this.add("drink-name"); }
...
get drinkLabel() { return this.add("drink-label"); }
get drinkLabelInput() { return this.add("drink-label-input"); }
...
get middleBar() { return this.add("middle-bar"); }
get resultsScale() { return this.add("results-scale"); }
get resultsGraph() { return this.add("results-graph"); }
get resultsDuiBar() { return this.add("results-dui-bar"); }
get resultsEstimate() { return this.add("results-estimate"); }
get duiLimit() { return this.add("dui-limit"); }
get bac_000() { return this.add("bac-000"); }
get bac_001() { return this.add("bac-001"); }
get bac_002() { return this.add("bac-002"); }
get bac_003() { return this.add("bac-003"); }
get bac_004() { return this.add("bac-004"); }
get bac_005() { return this.add("bac-005"); }
get bac_006() { return this.add("bac-006"); }
get bac_007() { return this.add("bac-007"); }
get bac_008() { return this.add("bac-008"); }
get bac_009() { return this.add("bac-009"); }
get bac_010() { return this.add("bac-010"); }
get bac_011() { return this.add("bac-011"); }
get bac_012() { return this.add("bac-012"); }
get bac_013() { return this.add("bac-013"); }
get bac_014() { return this.add("bac-014"); }
get bac_015() { return this.add("bac-015"); }
get bac_016() { return this.add("bac-016"); }
get bac_017() { return this.add("bac-017"); }
get bac_018() { return this.add("bac-018"); }
get bac_019() { return this.add("bac-019"); }
get resultsExtreme() { return this.add("results-extreme"); }
